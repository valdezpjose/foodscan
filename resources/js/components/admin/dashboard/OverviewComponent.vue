<template>
  ...
  <div class="col-12 sm:col-6 xl:col-3">
    <div class="p-4 rounded-lg flex items-center gap-4 bg-primary shadow-button hover:bg-primary-600 transition-colors">
      <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
        <i class="lab lab-total-sale lab-font-size-24 text-primary"></i>
      </div>
      <div>
  ...
  <!-- Total Orders (Azul) -->
  <div class="col-12 sm:col-6 xl:col-3">
    <div class="p-4 rounded-lg flex items-center gap-4 bg-secondary-700 shadow-blue hover:bg-secondary-600 transition-colors">
      <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
        <i class="lab lab-total-orders lab-font-size-24 text-secondary-700"></i>
      </div>
      <div>
  ...
  <!-- Total Customers (Naranja) -->
  <div class="col-12 sm:col-6 xl:col-3">
    <div class="p-4 rounded-lg flex items-center gap-4 bg-primary shadow-button hover:bg-primary-600 transition-colors">
      <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
        <i class="lab lab-total-customers lab-font-size-24 text-primary"></i>
      </div>
      <div>
  ...
  <!-- Total Menu Items (Azul) -->
  <div class="col-12 sm:col-6 xl:col-3">
    <div class="p-4 rounded-lg flex items-center gap-4 bg-secondary-700 shadow-blue hover:bg-secondary-600 transition-colors">
      <div class="w-12 h-12 rounded-full flex items-center justify-center bg-white">
        <i class="lab lab-total-menu-items lab-font-size-24 text-secondary-700"></i>
      </div>
      <div>
